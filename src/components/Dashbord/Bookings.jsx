...
const data = [
  { date: 'Mar 5', bookings: 400 },
  { date: 'Mar 6', bookings: 700 },
  { date: 'Mar 7', bookings: 500 },
  { date: 'Mar 8', bookings: 450 },
  { date: 'Mar 9', bookings: 900 },
];
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 flex flex-col md:flex-row gap-4 sm:gap-6 w-full">
      ...
      <div className="flex-[3]">
        <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-1">Bookings</h2>
        <div className="flex items-center justify-between mb-2">
          <h2 className="text-xs sm:text-sm font-semibold text-gray-800">Bookings</h2>
        ...
        <ResponsiveContainer width="100%" height={250} sm:height={300}>
          <BarChart data={data}>
            ...
            <Tooltip />
            <Bar dataKey="bookings" fill="#B2F5EA" radius={[8, 8, 0, 0]} barSize={40} sm:barSize={60} />
          </BarChart>
        </ResponsiveContainer>
      </div>
      ...
      <div className="flex-[1] space-y-3">
        <div className="bg-gray-100 rounded-md p-3 sm:p-4">
          <p className="text-xs sm:text-sm text-gray-600">Booking Rate</p>
          <p className="text-lg sm:text-xl font-bold text-gray-800">68%</p>
        </div>
        <div className="bg-gray-100 rounded-md p-3 sm:p-4">
          <p className="text-xs sm:text-sm text-gray-600">Booking Open Rate</p>
          <p className="text-lg sm:text-xl font-bold text-gray-800">80%</p>
        </div>
        <div className="bg-gray-100 rounded-md p-3 sm:p-4">
          <p className="text-xs sm:text-sm text-gray-600">Booking Click-Through Rate</p>
          <p className="text-lg sm:text-xl font-bold text-gray-800">70%</p>
        </div>
        <div className="bg-yellow-100 rounded-md p-3 sm:p-4">
          <p className="text-xs sm:text-sm text-yellow-800 font-medium">Booking Errors</p>
